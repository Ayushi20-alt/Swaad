...
import com.example.swaad.databinding.ActivityNewPasswordBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent newHome = new Intent(New_password.this, LoginActivity.class);
                startActivity(newHome);

            }
        });

        TextInputLayout txt1 = findViewById(R.id.textInputlayout1);
